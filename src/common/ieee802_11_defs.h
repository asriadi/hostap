...
#define WLAN_EID_FILS_PUBLIC_KEY 238
...
#define WLAN_EID_EXT_PMKID_LIST 0
...
/* Values of FILS Authentication Type field */
enum fils_auth_type {
	FILS_AUTH_SHARED_KEY = 0,
	FILS_AUTH_SHARED_KEY_PFS = 1,
	FILS_AUTH_PUBLIC_KEY = 2,
};

#define FILS_NONCE_LEN 16
#define FILS_SESSION_LEN 8
#define FILS_CACHE_ID_LEN 16
